    ...
    <>
      ...
      >
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-2xl bg-primary-500 flex items-center justify-center flex-shrink-0 shadow-lg group cursor-pointer transition-transform hover:scale-110">
      ...
      <nav className="flex-1 p-4 space-y-2 overflow-hidden">
        {collapsed && (
          <button
            ...
            className="w-full flex justify-center py-4 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-200"
            style={{ color: 'var(--muted)' }}
          >
